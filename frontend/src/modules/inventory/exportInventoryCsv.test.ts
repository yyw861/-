...
describe('inventoryCsv', () => {
  it('exports only supplied filtered rows with an UTF-8 BOM and escaped text', () => {
    const csv = inventoryCsv([{
      ...
      categoryCode: '69', categoryName: '球类', subCategoryId: 'sub-1', subCategoryCode: '01', subCategoryName: '篮球',
      brandId: 'brand-1', brandName: '品牌A', skuCode: 'BALL-1', barcode: '69001',
  ...
  it('neutralizes spreadsheet formulas in text fields', () => {
    const csv = inventoryCsv([{
      ...
      categoryCode: '00', categoryName: '+分类', subCategoryId: 'sub-1', subCategoryCode: '01', subCategoryName: '-小类',
      brandId: 'brand-1', brandName: '@品牌', skuCode: '-SKU', barcode: '00123',
